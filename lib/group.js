...
let { getBuffer, getGroupAdmins} = require("../lib/yntkts");
...
let fkontakk = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(anu.jid ? { remoteJid: '6285156476017-1604595598@g.us' } : {})}, message: { "contactMessage":{"displayName": `${mdata.subject}`,"vcard":`BEGIN:VCARD\nVERSION:3.0\nN:2;arifi;;;\nFN:arifi\nitem1.TEL;waid=6285156476017:62 851-564-76017\nitem1.X-ABLabel:Mobile\nEND:VCARD` }}}
let num = anu.participants[0]
let w = arifi.contacts[num] || { notify: num.replace(/@.+/, "") };
let anu_user = w.vname || w.notify || num.split("@")[0];
        try {
